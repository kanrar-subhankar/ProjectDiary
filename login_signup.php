...
<div id="error"></div>
<form id="shows" autocomplete="off" onsubmit="return validation()"; action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" role="form">
...
<form id="hides" autocomplete="off" onsubmit="return validation1()"; action="login_check.php" method="post" role="form">
<div class="row" style="margin-left:70px;margin-top:50px">
<div class="col-md-12">
